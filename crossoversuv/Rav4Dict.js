const Rav4LE_dict = {
    ...
    features: [
        ...
        "8-in. Toyota Audio Multimedia with wireless Apple CarPlay® & Android Auto™ compatibility",
        "SiriusXM® 3-month trial",
        "Safety Connect® with up to a 10-year trial. 4G network dependent."
    ],
    Drivetrain: [
        "2.5L 4-Cyl.",
...
const Rav4HybridSE_dict = {
    ...
    targetAudience: "The Toyota RAV4 Hybrid SE appeals to drivers seeking a sportier, eco-friendly crossover with enhanced performance, dynamic styling, and advanced hybrid technology for an active lifestyle."
}
const Rav4HybridWoodlandEdition_dict = {
    price: "$35,120",
    milage: "38/35",
    seats: "5",
    features: [
